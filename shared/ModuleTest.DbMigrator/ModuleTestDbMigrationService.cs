...
public class ModuleTestDbMigrationService : ITransientDependency
{
    private readonly ILogger<ModuleTestDbMigrationService> _logger;
    private readonly ITenantRepository _tenantRepository;
    private readonly IDataSeeder _dataSeeder;
    private readonly ICurrentTenant _currentTenant;
    private readonly IUnitOfWorkManager _unitOfWorkManager;

    public ModuleTestDbMigrationService(
        ILogger<ModuleTestDbMigrationService> logger,
